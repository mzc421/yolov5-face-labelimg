...
def parse_opt():
    ...
    parser.add_argument("--weights", nargs="+", type=str, default=r'D:\BaiduNetdiskDownload\face-labeling-master\face-labeling-master\models\darkface-m.pt', help="model path or triton URL")
